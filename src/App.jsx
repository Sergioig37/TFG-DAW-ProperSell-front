    ...
    <>
      <BrowserRouter>
        <Routes>
          ...
          <Route
            path="/cliente/:id/propiedad/create"
            element={<PropiedadCreate />}
          />
          ...
          <Route
            path="/admin/alerta-dashboard"
            element={<AlertasDashboard />}
          />
          <Route
            path="/admin/propiedades-dashboard"
            element={<PropiedadesDashboard />}
          />
          <Route
