...
export const PropiedadesDashboard = () => {
  ...
  const handleHabilitado = (id, enabled) => {
    ...
    fetch(
      import.meta.env.VITE_LOCALHOST_URL + `propiedad/enabled/${id}/${enabled}`,
      {
        method: "PUT",
        headers: {
                  ...
                  <tr key={propiedad.id}>
                    ...
                    <td>
                      {propiedad.habilitado ? (
                        <Button
                          variant="danger"
                          onClick={() => handleHabilitado(propiedad.id, false)}
                        >
                          Deshabilitar
                        </Button>
                      ) : (
                        <Button
                          variant="success"
                          onClick={() => handleHabilitado(propiedad.id, true)}
                        >
                          Habilitar
                        </Button>
                      )}
